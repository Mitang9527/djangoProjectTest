...
设计：与 :class:`extensions.web_automation.selenium.SeleniumClient` 对齐，
...
from ..selenium.locator import By as _SharedBy, Waiter
...
class By(_SharedBy):
    """扩展 :class:`extensions.web_automation.selenium.By`，加上 appium 特有策略。"""

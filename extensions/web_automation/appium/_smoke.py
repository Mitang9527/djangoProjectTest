...
from extensions.web_automation.appium import (
    AppiumClient,
    By,
    Waiter,
    get_default_client,
...
class TestExceptions(unittest.TestCase):
    ...
    def test_separate_from_selenium(self):
        # appium 异常在 extensions.web_automation.appium.exceptions 中定义，但
        # 实际 import 走的是 extensions.web_automation.selenium.exceptions
        from extensions.web_automation.appium import exceptions as ex_mod
...
class TestServerNotRunning(unittest.TestCase):
    def test_connection_refused(self):
        with patch("extensions.web_automation.appium.client.appium_webdriver.Remote") as mock_remote:
...
class TestDefaultClient(unittest.TestCase):
    def test_get_default_singleton(self):
        from extensions.web_automation.appium import client as cli_mod
        d1 = FakeAppiumDriver()
        d2 = FakeAppiumDriver()
        c1 = _make_client(d1)

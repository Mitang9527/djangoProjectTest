...
from utils.i18n.translations import (
    CacheTranslationBackend,
    TranslationBackend,
)
from utils.i18n.exceptions import I18nError
...
class DetectLanguageTest(unittest.TestCase):
    ...
    def test_detect_from_header(self):
        from utils.i18n.core import detect_language
    ...
    def test_priority_header_over_query(self):
        """Header 优先级高于 Query"""
        from utils.i18n.core import detect_language, _get_detector_order
...
class ExceptionsTest(unittest.TestCase):
    ...
    def test_unsupported_language_error(self):
        from utils.i18n.exceptions import UnsupportedLanguageError
    ...
    def test_translation_not_found(self):
        from utils.i18n.exceptions import TranslationNotFoundError

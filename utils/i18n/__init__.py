...
**1. 启用租户级语言**::
    ...
    # settings.py
    INSTALLED_APPS += ["utils.i18n"]
    MIDDLEWARE.insert(0, "utils.i18n.middleware.I18nMiddleware")

**2. 探测并激活当前语言**::

    # DRF View
    from utils.i18n import activate_for_request
...
**3. 动态翻译（数据库驱动）**::
    ...
    from utils.i18n import t, register_translation
...
**5. 非请求上下文激活**::
    ...
    from utils.i18n import activate_language

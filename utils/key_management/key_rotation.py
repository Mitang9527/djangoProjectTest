...
# 现在导入其他模块
from utils.key_management.security import generate_secret_key
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("""
用法:
    python utils/key_management/key_rotation.py status          # 查看当前密钥状态
    python utils/key_management/key_rotation.py rotate [days]   # 轮换密钥（默认保留7天）
    python utils/key_management/key_rotation.py list            # 列出所有密钥信息
        """)
        sys.exit(0)

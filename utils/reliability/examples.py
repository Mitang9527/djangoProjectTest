...
def example_2_circuit_breaker():
    from utils.reliability import circuit_breaker, CircuitOpenError
    from utils.reliability.state_store import set_state_store, InMemoryStateStore
...
def example_3_bulkhead():
    from utils.reliability import bulkhead, BulkheadFullError
    import threading

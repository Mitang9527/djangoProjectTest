...
**1) 在 settings.py 注册版本**::
    ...
    from utils.versioning import VersionSpec, register_version, VersioningConfig
...
**2) 视图层使用**::
    ...
    from utils.versioning import versioned_view
...
**3) 装饰器：方法级灰度**::
    ...
    from utils.versioning import only_for, since, until

...
class GlobalConfigAdmin(admin.ModelAdmin):
    list_display = ['key', 'name', 'config_type', 'category', 'is_active', 'is_public', 'created_by', 'updated_at']
    list_filter = ['config_type', 'category', 'is_active', 'is_public']
...
class FeatureFlagAdmin(admin.ModelAdmin):
    list_display = ['key', 'name', 'status', 'rollout_strategy', 'rollout_percentage', 'created_by', 'updated_at']
    list_filter = ['status', 'rollout_strategy']
    search_fields = ['key', 'name', 'description']
    filter_horizontal = ['target_users', 'target_tenants']
...
class ConfigHistoryAdmin(admin.ModelAdmin):
    list_display = ['config_key', 'config_type', 'operation', 'operator', 'created_at']
    list_filter = ['config_type', 'operation']
